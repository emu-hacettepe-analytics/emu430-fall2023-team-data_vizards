...
We also used the rep function with the help of an AI tool. [^1]:  
[^1]:  migrationcause <- rep(...): This part creates a vector named migrationcause by repeating the specified migration causes for each row in the migration data frame. The rep function is used for repetition.
