...
education_migration <- merged_data %>%
  pivot_longer(cols = c(university2, doctorate, highschool2, elementaryschool2, middleschool2),
               names_to = "education_level", values_to = "migration_count") %>%
  mutate(
    education_level = case_when(
      education_level == "university2" ~ "University",
...
# Education_level s??tununu fakt??r olarak d??zenleyerek s??ralama yapma
